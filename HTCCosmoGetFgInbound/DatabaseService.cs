...
namespace HTCCosmoGetFgInbound
{
    internal class DatabaseService
    {
        ...
        public static int testMysqlNonQuery()
        {
            MySqlConnection getCosmoConnection = DatabaseClass.CosmoWmsConnection();
            int result = 0;

            String postCosmoUpdateStatement = string.Format("UPDATE cosmo_wms_9771.ods_pro_storage_records_sn SET add1 = NULL WHERE row_id = '{0}'", "45407");
            result = DatabaseClass.MySqlExecuteNonQuery(getCosmoConnection, postCosmoUpdateStatement);
